...
semv=22.1.8 base=llvm-project-$semv.src.tar.xz url=github.com/llvm/llvm-project/releases/download/llvmorg-$semv/$base
(
    get 62fd2d86c41d743d8355aa38de6b45a712b7919ab0d97de8d7a6e503ef83b2f2; set -f
